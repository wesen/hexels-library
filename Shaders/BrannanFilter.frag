#define PFX_SHADER
//lets Hexels know this is a post-effect shader as opposed to a blend shader
 ...
 *
 * Write-ups:
 * [1] http://blog.ruofeidu.com/implementing-instagram-filters/
 **/
...
void main()
{
  ...
  vec4 fragColor = texture2D(_Layer, gl_TexCoord[0].xy);
